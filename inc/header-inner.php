...
?>
  <!--Preloader start here-->
      ...
      <!--Header Start-->
      <header id="rs-header" class="rs-header2 inner-pages">
         <!-- Toolbar Start -->
               ...
               <div class="row">
                  ...
                  <div class="col-sm-9">
                     ...
                     <nav class="rs-menu">
                        <ul class="nav-menu">
                           <!-- Home -->
                           <li class="<?php if($active=="home"){ echo "current-menu-item current_page_item"; }?>"> <a href="<?php echo($base); ?>/" class="home" title="Wem Technical Services">Home</a>
                           </li>
                           <!-- End Home --> 
                          
                           <!--Service Menu Start-->
                           <li class="menu-item-has-children <?php if($active=="services"){ echo "current-menu-item current_page_item"; }?>">
                              <a href="<?php echo($base); ?>/services/" title="Services Offered by WEM Technical Services">Service</a>
                              <ul class="sub-menu">
                                 
                                 <li><a href="<?php echo($base); ?>/services/concrete-cutting/" title="Concrete Cutting Dubai">Concrete Cutting</a>
                                 <!-- <ul class="sub-menu">
                                    <li><a href="#">Slab</a></li>
                                    <li><a href="#">Wall</a></li>
                                 </ul> -->
                              ...
                              <li><a href="<?php echo($base); ?>/services/core-drilling/" title="Core Drilling Services Dubai">Core Drilling</a></li>
                           ...
                           <!--Service Menu End-->
                           <!--Projects Menu Start-->
                           <li class="<?php if($active=="projects"){ echo "current-menu-item current_page_item"; }?>"> <a href="<?php echo($base); ?>/projects/" title="Demolition Projects done by WEM Technical Services">Projects</a>
                           </li>
                           <!--Projects Menu End-->
                           <!--Rentals Menu Start-->
                           ...
                           <!--Rentals Menu End-->
                           <!--About Menu Start-->
                           <li class="<?php if($active=="about"){ echo "current-menu-item current_page_item"; }?>">
                              <a href="<?php echo($base); ?>/about/" title="About Wem Technical Services">About Us</a>
                              <ul class="sub-menu">
